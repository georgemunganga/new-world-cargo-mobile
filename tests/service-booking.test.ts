...
describe("service-specific booking readiness", () => {
  it("requires a freight method and core import route, cargo, and consignee information", () => {
    const draft = { service: "import" as const, method: "air" as const, originCountry: "China", originCity: "Guangzhou", originBranchId: "4", destinationCity: "Lusaka", destinationBranchId: "1", cargoCategory: "general", consignee: { name: "Chanda Mwila", phone: "+260971000000" } };
  ...
  it("requires a city route, cargo, contacts, and fulfilment method for City-to-City", () => {
    const draft = { service: "intercity" as const, originCity: "Lusaka", originBranchId: "1", destinationCity: "Kitwe", destinationBranchId: "3", cargoCategory: "cartons", sender: { name: "Chanda", phone: "+260971000000" }, receiver: { name: "Mwila", phone: "+260977000000" }, fulfilment: "collection" as const };
