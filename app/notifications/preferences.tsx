...
export default function NotificationPreferencesScreen() {
  ...
  if (status === "loading" || status === "idle") return <Screen><View style={{padding:20,gap:20}}><IconButton label="Go back" icon="arrow-left" onPress={() => router.back()} /><ListSkeleton count={3} /></View></Screen>;
