...
import { useNotificationPreferences, type NotificationPreferences } from "@/stores/notification-preferences";
...
export default function NotificationPreferencesScreen() {
  const { preferences, setPreference, setAllPreferences } = useNotificationPreferences();
