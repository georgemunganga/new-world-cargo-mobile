...
const styles = StyleSheet.create({
  ...
  methods: { gap: 9 }, methodsHeader: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" }, manageMethods: { minHeight: 32, paddingHorizontal: 5, justifyContent: "center" }, manageMethodsText: { color: nwcColors.info, fontSize: 11, lineHeight: 15, fontFamily: "Poppins_800ExtraBold" },
