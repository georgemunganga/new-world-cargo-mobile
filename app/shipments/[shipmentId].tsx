...
export default function ShipmentDetailScreen() {
  ...
  const downloadProof = () => { void exportProofOfDelivery(shipment).then((result) => Alert.alert(result.status === "downloaded" ? "Proof downloaded" : "Proof ready", result.status === "downloaded" ? `${result.filename} was downloaded.` : "Proof download is ready, but this device needs native file saving enabled.")); };
