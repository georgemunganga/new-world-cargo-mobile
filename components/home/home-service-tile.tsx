...
const styles = StyleSheet.create({
  ...
  compactVehicleImage: { right: -6, bottom: -6, width: 78, height: 58 },
  customIcon: { position: "absolute", right: 11, bottom: 12 },
  compactCustomIcon: { position: "absolute", right: 12, bottom: 12 },
});
