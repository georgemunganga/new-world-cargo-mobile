...
const styles = StyleSheet.create({
  ...
  routeReadyPill: { position: "absolute", top: 82, alignSelf: "center", minHeight: 35, paddingHorizontal: 12, borderRadius: 13, backgroundColor: "rgba(255,255,255,0.96)", flexDirection: "row", alignItems: "center", gap: 5 },
  routeReadyText: { color: nwcColors.success, fontSize: 12, lineHeight: 16, fontFamily: "Poppins_800ExtraBold" },
});
