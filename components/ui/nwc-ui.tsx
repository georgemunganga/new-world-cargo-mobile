...
const styles = StyleSheet.create({
  primaryButton: { minHeight: 54, borderRadius: nwcRadii.control, backgroundColor: nwcColors.primary, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8, paddingHorizontal: 18 },
  primaryButtonText: { color: nwcColors.primaryInk, fontSize: 16, lineHeight: 21, fontFamily: "Poppins_800ExtraBold" },
  secondaryButton: { minHeight: 52, borderRadius: nwcRadii.control, borderWidth: 1, borderColor: nwcColors.border, backgroundColor: nwcColors.surface, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8, paddingHorizontal: 18 },
  secondaryButtonText: { color: nwcColors.brandNavy, fontSize: 15, lineHeight: 20, fontFamily: "Poppins_700Bold" },
  disabledButton: { opacity: 0.48 },
  iconButton: { width: 44, height: 44, borderRadius: 22, borderWidth: 1, borderColor: nwcColors.border, backgroundColor: nwcColors.surface, alignItems: "center", justifyContent: "center" },
  ...
  card: { backgroundColor: nwcColors.surface, borderWidth: 1, borderColor: nwcColors.border, borderRadius: nwcRadii.card, padding: 18 },
  sectionHeader: { alignItems: "center", flexDirection: "row", justifyContent: "space-between", gap: 16, marginBottom: 12 },
  sectionTitleWrap: { flexShrink: 1 },
  eyebrow: { color: nwcColors.warning, fontSize: 11, lineHeight: 15, fontFamily: "Poppins_800ExtraBold", letterSpacing: 0.9, textTransform: "uppercase", marginBottom: 3 },
  sectionTitle: { color: nwcColors.foreground, fontSize: 20, lineHeight: 26, fontFamily: "Poppins_800ExtraBold" },
  statusBadge: { flexDirection: "row", alignItems: "center", gap: 5, borderRadius: nwcRadii.pill, alignSelf: "flex-start", paddingVertical: 6, paddingHorizontal: 9 },
  statusBadgeText: { fontSize: 12, lineHeight: 16, fontFamily: "Poppins_800ExtraBold" },
  heading: { color: nwcColors.foreground, fontSize: 30, lineHeight: 37, fontFamily: "Poppins_800ExtraBold", letterSpacing: -0.5 },
  body: { color: nwcColors.muted, fontSize: 15, lineHeight: 22, fontFamily: "Poppins_500Medium" },
